...
class ElasticSearchHandlerTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->client = $this->getMockBuilder('Elastica\Client')->setMethods([ 'addDocuments' ])->disableOriginalConstructor()->getMock();
    }
    ...
    public function testHandleIntegration()
    {
        ...
        $document = $this->getDocSourceFromElastic($client, $this->options['index'], $this->options['type'],
            $documentId);
