...
abstract class PHP_CodeCoverage_TestCase extends PHPUnit_Framework_TestCase
{
    ...
    protected function getCoverageForBankAccount()
    {
        ...
        $coverage->stop(true, [ TEST_FILES_PATH . 'BankAccount.php' => range(6, 9) ]);

        $coverage->start(new BankAccountTest('testBalanceCannotBecomeNegative'));

        $coverage->stop(true, [ TEST_FILES_PATH . 'BankAccount.php' => range(27, 32) ]);

        $coverage->start(new BankAccountTest('testBalanceCannotBecomeNegative2'));

        $coverage->stop(true, [ TEST_FILES_PATH . 'BankAccount.php' => range(20, 25) ]);
