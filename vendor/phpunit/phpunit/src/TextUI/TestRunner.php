...
class PHPUnit_TextUI_TestRunner extends PHPUnit_Runner_BaseTestRunner
{
    ...
    private function processSuiteFilters(PHPUnit_Framework_TestSuite $suite, array $arguments)
    {
        ...
        if ( ! empty( $arguments['excludeGroups'] )) {
            $filterFactory->addFilter(new ReflectionClass('PHPUnit_Runner_Filter_Group_Exclude'),
    ...
    public function doRun(PHPUnit_Framework_Test $suite, array $arguments = [ ])
    {
        ...
        if ($this->printer === null) {
            if (isset( $arguments['printer'] ) && $arguments['printer'] instanceof PHPUnit_Util_Printer) {
                ...
                if (isset( $arguments['printer'] ) && is_string($arguments['printer']) && class_exists($arguments['printer'],
                        false)
                ) {
                ...
                $this->printer = new $printerClass(isset( $arguments['stderr'] ) ? 'php://stderr' : null,
                    $arguments['verbose'], $arguments['colors'], $arguments['debug'], $arguments['columns']);
            }
        }
        ...
        if (isset( $codeCoverage )) {
            ...
            if (isset( $arguments['coverageHtml'] )) {
                ...
                try {
                    $writer = new PHP_CodeCoverage_Report_HTML($arguments['reportLowUpperBound'],
                        $arguments['reportHighLowerBound'],
                        sprintf(' and <a href="https://phpunit.de/">PHPUnit %s</a>', PHPUnit_Runner_Version::id()));
            ...
            if (isset( $arguments['coverageText'] )) {
                ...
                $processor = new PHP_CodeCoverage_Report_Text($arguments['reportLowUpperBound'],
