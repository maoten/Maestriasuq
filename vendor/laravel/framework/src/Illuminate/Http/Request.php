 ...
 * @property mixed propuesta
 * @property mixed user
 * @property mixed nombre
 * @property mixed universidad
 * @property mixed telefono
 * @property mixed profesion
 * @property mixed cc
 * @property mixed email
 * @property mixed jurados
...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    {
        return count($this->query()) > 0 ? $this->url() . '/?' . http_build_query(array_merge($this->query(),
                $query)) : $this->fullUrl() . '?' . http_build_query($query);
    }
    ...
    public function fingerprint()
    {
        ...
        return sha1(implode('|',
                $this->route()->methods()) . '|' . $this->route()->domain() . '|' . $this->route()->uri() . '|' . $this->ip());
    }
