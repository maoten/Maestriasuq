...
trait MakesHttpRequests
{
    ...
    protected function seeCookie($cookieName, $value = null, $encrypted = true)
    {
        ...
        return $this->assertEquals($actual, $value,
    ...
    public function call($method, $uri, $parameters = [ ], $cookies = [ ], $files = [ ], $server = [ ], $content = null)
    {
        ...
        $request = Request::create($this->currentUri, $method, $parameters, $cookies, $files,
            array_replace($this->serverVariables, $server), $content);
