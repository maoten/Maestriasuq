...
class XliffFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testIncompleteResource()
    {
        ...
        $this->assertEquals([ 'foo' => 'bar', 'extra' => 'extra', 'key' => '', 'test' => 'with' ],
    ...
    public function testEncoding()
    {
        ...
        $this->assertEquals([ 'notes' => [ [ 'content' => utf8_decode('bäz') ] ] ],
    ...
    public function testLoadNotes()
    {
        ...
        $this->assertEquals([ 'notes' => [ [ 'priority' => 1, 'content' => 'foo' ] ] ],
            $catalogue->getMetadata('foo', 'domain1'));
        // message without target
        $this->assertEquals([ 'notes' => [ [ 'content' => 'bar', 'from' => 'foo' ] ] ],
