...
class TranslatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function getHtmlIdsTestData()
    {
        return [
            ...
            [
                'li:nth-child(n)',
                [ 'first-li', 'second-li', 'third-li', 'fourth-li', 'fifth-li', 'sixth-li', 'seventh-li' ]
            ],
            [
                'li:nth-child(n-1)',
                [ 'first-li', 'second-li', 'third-li', 'fourth-li', 'fifth-li', 'sixth-li', 'seventh-li' ]
            ...
            [
                ...
                [ 'name-anchor', 'first-li', 'li-div', 'p-b', 'checkbox-fieldset-disabled', 'area-href' ]
            ],
            ...
            [
                ':disabled',
                [ 'checkbox-disabled', 'checkbox-disabled-checked', 'fieldset', 'checkbox-fieldset-disabled' ]
            ],
