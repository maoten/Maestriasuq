...
class ControllerResolverTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetControllerWithClassAndMethod()
    {
        ...
        $request->attributes->set('_controller',
            [ 'Symfony\Component\HttpKernel\Tests\Controller\ControllerResolverTest', 'controllerMethod4' ]);
        $controller = $resolver->getController($request);
        $this->assertSame([
    ...
    public function testGetArguments()
    {
        ...
        $this->assertEquals([ ], $resolver->getArguments($request, $controller),
        ...
        $this->assertEquals([ $request ], $resolver->getArguments($request, $controller),
