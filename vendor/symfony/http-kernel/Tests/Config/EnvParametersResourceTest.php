...
class EnvParametersResourceTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertSame([ 'prefix' => $this->prefix, 'variables' => $this->initialEnv ],
    ...
    {
        $this->assertSame(serialize([ 'prefix' => $this->prefix, 'variables' => $this->initialEnv ]),
    ...
    {
        $this->assertTrue($this->resource->isFresh(time()),
    ...
    public function testIsFreshValueChanged()
    {
        ...
        $this->assertFalse($this->resource->isFresh(time()),
