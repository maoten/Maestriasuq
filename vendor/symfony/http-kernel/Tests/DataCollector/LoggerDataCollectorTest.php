        ...
        return [
            ...
            [
                ...
                [
                    [
                        'message'      => 'foo',
                        'context'      => [ 'type' => E_DEPRECATED, 'level' => E_ALL ],
                        'priority'     => 100,
                        'priorityName' => 'DEBUG'
                    ],
                    [
                        'message'      => 'foo2',
                        'context'      => [ 'type' => E_USER_DEPRECATED, 'level' => E_ALL ],
                        'priority'     => 100,
                        'priorityName' => 'DEBUG'
                    ],
                ],
            ...
            [
                ...
                [
                    [
                        'message'      => 'foo3',
                        'context'      => [ 'type' => E_USER_WARNING, 'level' => 0, 'file' => __FILE__, 'line' => 123 ],
                        'priority'     => 100,
                        'priorityName' => 'DEBUG'
                    ],
                    [
