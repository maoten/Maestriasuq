...
class HIncludeFragmentRenderer extends RoutableFragmentRenderer
{
     ...
     * Constructor.
     *
     * @param EngineInterface|\Twig_Environment $templating            An EngineInterface or a \Twig_Environment
     *                                                                 instance
     * @param UriSigner                         $signer                A UriSigner instance
     * @param string                            $globalDefaultTemplate The global default content (it can be a template
     *                                                                 name or the content)
    ...
    public function render($uri, Request $request, array $options = [ ])
    {
        ...
        if (count($attributes) > 0) {
            ...
            foreach ($attributes as $attribute => $value) {
                $renderedAttributes .= sprintf(' %s="%s"', htmlspecialchars($attribute, $flags, $this->charset, false),
