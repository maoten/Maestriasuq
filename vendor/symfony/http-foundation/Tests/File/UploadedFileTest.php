...
class UploadedFileTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $file = new UploadedFile(__DIR__ . '/Fixtures/.unknownextension', 'original.gif', null,
            filesize(__DIR__ . '/Fixtures/.unknownextension'), UPLOAD_ERR_OK);
    ...
    {
        $file = new UploadedFile(__DIR__ . '/Fixtures/test.gif', 'original.gif', 'image/gif',
    ...
    {
        $file = new UploadedFile(__DIR__ . '/Fixtures/test.gif', 'original.gif', 'image/jpeg',
            filesize(__DIR__ . '/Fixtures/test.gif'), null);
    ...
    {
        $file = new UploadedFile(__DIR__ . '/Fixtures/test.gif', 'original.gif', null,
            filesize(__DIR__ . '/Fixtures/test.gif'), UPLOAD_ERR_OK, true);
    ...
    {
        $file = new UploadedFile(__DIR__ . '/Fixtures/test.gif', 'original.gif', null,
            filesize(__DIR__ . '/Fixtures/test.gif'), $error);
