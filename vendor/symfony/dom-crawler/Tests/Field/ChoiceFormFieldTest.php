...
class ChoiceFormFieldTest extends FormFieldTestCase
{
    ...
    public function testRadioButtons()
    {
        ...
        $node  = $this->createNode('input', '',
            [ 'type' => 'radio', 'name' => 'name', 'value' => 'bar', 'checked' => 'checked' ]);
        $field->addChoice($node);
    ...
    public function testRadioButtonsWithEmptyBooleanAttribute()
    {
        ...
        $field = new ChoiceFormField($node);
        $node  = $this->createNode('input', '',
            [ 'type' => 'radio', 'name' => 'name', 'value' => 'bar', 'checked' => '' ]);
        $field->addChoice($node);
    ...
    {
        $node  = $this->createNode('input', '',
            [ 'type' => 'radio', 'name' => 'name', 'value' => 'foo', 'disabled' => 'disabled' ]);
        $field = new ChoiceFormField($node);
        $node  = $this->createNode('input', '', [ 'type' => 'radio', 'name' => 'name', 'value' => 'bar' ]);
        $field->addChoice($node);
        $node = $this->createNode('input', '',
            [ 'type' => 'radio', 'name' => 'name', 'value' => 'baz', 'disabled' => '' ]);
        $field->addChoice($node);
    ...
    public function testCheckboxes()
    {
        ...
        $node  = $this->createNode('input', '',
            [ 'type' => 'checkbox', 'name' => 'name', 'checked' => 'checked', 'value' => 'foo' ]);
        $field = new ChoiceFormField($node);
    ...
    {
        $node  = $this->createNode('input', '',
            [ 'type' => 'checkbox', 'name' => 'name', 'value' => 'foo', 'checked' => '' ]);
        $field = new ChoiceFormField($node);
