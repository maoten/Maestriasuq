...
class FormatterHelperTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFormatSection()
    {
        ...
        $this->assertEquals('<info>[cli]</info> Some text to display',
    ...
    public function testFormatBlock()
    {
        ...
        $this->assertEquals('<error> Some text to display </error>',
            $formatter->formatBlock('Some text to display', 'error'), '::formatBlock() formats a message in a block');
    ...
    public function testFormatBlockWithDoubleWidthDiacriticLetters()
    {
        ...
        $this->assertEquals('<error>                    </error>' . "\n" . '<error>  表示するテキスト  </error>' . "\n" . '<error>                    </error>',
            $formatter->formatBlock('表示するテキスト', 'error', true), '::formatBlock() formats a message in a block');
    }
    ...
    public function testFormatBlockLGEscaping()
    {
        ...
        $this->assertEquals('<error>                            </error>' . "\n" . '<error>  \<info>some info\</info>  </error>' . "\n" . '<error>                            </error>',
            $formatter->formatBlock('<info>some info</info>', 'error', true), '::formatBlock() escapes \'<\' chars');
    }
}
