...
class Person extends \Faker\Provider\Person
{
    ...
    public function cnp($gender = null, $century = null, $county = null)
    {
        ...
        $cnp = (string) static::cnpFirstDigit($gender, $century) . static::numerify('##') . sprintf('%02d',
                $this->generator->month()) . sprintf('%02d',
                $this->generator->dayOfMonth()) . $countyCode . static::numerify('##%');
