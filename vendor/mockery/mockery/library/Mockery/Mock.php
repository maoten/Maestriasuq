...
class Mock implements MockInterface
{
    ...
    public function shouldReceive()
    {
        ...
        $lastExpectation = \Mockery::parseShouldReturnArgs($this, func_get_args(),
            function ($method) use ($self, $nonPublicMethods, $allowMockingProtectedMethods) {
    ...
    public function mockery_validateOrder($method, $order)
    {
        if ($order < $this->_mockery_currentOrder) {
            ...
            $exception->setMock($this)->setMethodName($method)->setExpectedOrder($order)->setActualOrder($this->_mockery_currentOrder);
            throw $exception;
        }
    ...
    protected static function _mockery_handleStaticMethodCall($method, array $args)
    {
        try {
            ...
            throw new \BadMethodCallException('Static method ' . $associatedRealObject->mockery_getName() . '::' . $method . '() does not exist on this mock object');
        }
    }
    ...
    protected function _mockery_handleMethodCall($method, array $args)
    {
        ...
        throw new \BadMethodCallException('Method ' . __CLASS__ . '::' . $method . '() does not exist on this mock object');
    }
