...
class BlacklistTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertFalse($this->blacklist->isStaticAttributeBlacklisted('SebastianBergmann\GlobalState\TestFixture\BlacklistedClass',
            'attribute'));
    }
    ...
    public function testClassCanBeBlacklisted()
    {
        ...
        $this->assertTrue($this->blacklist->isStaticAttributeBlacklisted('SebastianBergmann\GlobalState\TestFixture\BlacklistedClass',
            'attribute'));
    }
    ...
    public function testSubclassesCanBeBlacklisted()
    {
        ...
        $this->assertTrue($this->blacklist->isStaticAttributeBlacklisted('SebastianBergmann\GlobalState\TestFixture\BlacklistedChildClass',
            'attribute'));
    }
    ...
    public function testImplementorsCanBeBlacklisted()
    {
        ...
        $this->assertTrue($this->blacklist->isStaticAttributeBlacklisted('SebastianBergmann\GlobalState\TestFixture\BlacklistedImplementor',
            'attribute'));
    }
