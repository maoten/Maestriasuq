...
LONGDESC;
        ...
        $this->assertInstanceOf(__NAMESPACE__ . '\Tag\LinkTag', $parsedContents[1]);
        $this->assertSame(' that uses inline
...
LONGDESC;
        ...
        $this->assertInstanceOf(__NAMESPACE__ . '\Tag\LinkTag', $parsedContents[1]);
        $this->assertSame(' is text for a description that uses inline
tags.', $parsedContents[2]);
    }
...
LONGDESC;
        ...
        $this->assertSame('This is text for a description with ', $parsedContents[0]);
        ...
        $this->assertInstanceOf(__NAMESPACE__ . '\Tag\LinkTag', $parsedDescription[1]);
...
LONGDESC;
        ...
        $parsedContents = $object->getParsedContents();
        $this->assertCount(3, $parsedContents);
        $this->assertSame('This is text for a description containing ', $parsedContents[0]);
        $this->assertInstanceOf(__NAMESPACE__ . '\Tag', $parsedContents[1]);
        $this->assertSame('.', $parsedContents[2]);
...
LONGDESC;
        ...
        $parsedContents = $object->getParsedContents();
        $this->assertCount(1, $parsedContents);
        $this->assertSame('This is text for a description with } that is not a tag.', $parsedContents[0]);
    }
...
LONGDESC;
        ...
        $parsedContents = $object->getParsedContents();
        $this->assertCount(1, $parsedContents);
        $this->assertSame('This is text for a description with literal {@link}.', $parsedContents[0]);
    }
