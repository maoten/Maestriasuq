...
HTML;
    ...
    public function testHasAReadableDescription()
    {
        ...
        $this->assertDescription('XML or HTML document with XPath "/users/user/name"' . ' a string starting with "Alice"',
    ...
    public function testHasAReadableMismatchDescription()
    {
        ...
        $this->assertMismatchDescription('XPath returned ["alice", "bob", "charlie"]',
            hasXPath('/users/user/id', 'Frank'), self::$doc);
    }
}
