...
class Swift_ByteStream_ArrayByteStreamTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testReadingMultipleBytesFromBaseInput()
    {
        ...
        $this->assertEquals([ 'ab', 'cd' ], $output, '%s: Bytes read from stream should be in pairs');
    }
    ...
    public function testBindingOtherStreamsMirrorsWriteOperations()
    {
        ...
        $is2->expects($this->at(0))->method('write')->with('x');
        $is2->expects($this->at(1))->method('write')->with('y');
