...
class Swift_Mime_Headers_ParameterizedHeaderTest extends \SwiftMailerTestCase
{
    ...
    {
        $header = $this->_getHeader('Content-Type', $this->_getHeaderEncoder('Q', true),
    ...
    {
        $header = $this->_getHeader('Content-Disposition', $this->_getHeaderEncoder('Q', true),
            $this->_getParameterEncoder(true));
    ...
    public function testLongParamsAreBrokenIntoMultipleAttributeStrings()
    {
        ...
        */
        ...
        $this->assertEquals('attachment; ' . 'filename*0*=utf-8\'\'' . str_repeat('a',
    ...
    public function testEncodedParamDataIncludesCharsetAndLanguage()
    {
        ...
        */
        ...
        $this->assertEquals('attachment; filename*=' . $this->_charset . "'" . $this->_lang . "'" . str_repeat('a',
                20) . '%8F' . str_repeat('a', 10), $header->getFieldBody());
    }
    ...
    public function testMultipleEncodedParamLinesAreFormattedCorrectly()
    {
     ...
     (5)   If the first segment of a continued parameter value is
        ...
        */
        ...
        $header->setMaxLineLength(78);
        $header->setLanguage($this->_lang);
        $this->assertEquals('attachment; filename*0*=' . $this->_charset . "'" . $this->_lang . "'" . str_repeat('a',
                20) . '%8F' . str_repeat('a', 28) . ";\r\n " . 'filename*1*=' . str_repeat('a', 32),
            $header->getFieldBody());
    }
