...
class Swift_Mime_Headers_MailboxHeaderTest extends \SwiftMailerTestCase
{
    ...
    public function testMailboxIsSetForAddress()
    {
        ...
        $this->assertEquals([ 'chris@swiftmailer.org' ], $header->getNameAddressStrings());
    }
    ...
    public function testMailboxIsRenderedForNameAddress()
    {
        ...
        $this->assertEquals([ 'Chris Corbyn <chris@swiftmailer.org>' ], $header->getNameAddressStrings());
    }
    ...
    public function testQuotesInNameAreQuoted()
    {
        ...
        $this->assertEquals([ '"Chris Corbyn, \"DHE\"" <chris@swiftmailer.org>' ], $header->getNameAddressStrings());
    }
    ...
    public function testEscapeCharsInNameAreQuoted()
    {
        ...
        $this->assertEquals([ '"Chris Corbyn, \\\\escaped\\\\" <chris@swiftmailer.org>' ],
    ...
    public function testGetMailboxesReturnsNameValuePairs()
    {
        ...
        $this->assertEquals([ 'chris@swiftmailer.org' => 'Chris Corbyn, DHE' ], $header->getNameAddresses());
    }
    ...
    public function testMultipleAddressesCanBeSetAndFetched()
    {
        ...
        $this->assertEquals([ 'chris@swiftmailer.org', 'mark@swiftmailer.org' ], $header->getAddresses());
    }
    ...
    public function testMultipleAddressesAsMailboxes()
    {
        ...
        $this->assertEquals([ 'chris@swiftmailer.org' => null, 'mark@swiftmailer.org' => null ],
    ...
    public function testMultipleAddressesAsMailboxStrings()
    {
        ...
        $this->assertEquals([ 'chris@swiftmailer.org', 'mark@swiftmailer.org' ], $header->getNameAddressStrings());
    }
    ...
    public function testNameIsEncodedIfNonAscii()
    {
        ...
        $this->assertEquals('Chris =?' . $this->_charset . '?Q?C=8Frbyn?= <chris@swiftmailer.org>',
    ...
    public function testGetValueReturnsMailboxStringValueForMultipleMailboxes()
    {
        ...
        $this->assertEquals('Chris Corbyn <chris@swiftmailer.org>, Mark Corbyn <mark@swiftmailer.org>',
            $header->getFieldBody());
    }
    ...
    public function testRemoveAddressesWithList()
    {
        ...
        $header->removeAddresses([ 'chris@swiftmailer.org', 'mark@swiftmailer.org' ]);
    ...
    private function _getEncoder($type, $stub = false)
    {
        ...
        $encoder->shouldReceive('getName')->zeroOrMoreTimes()->andReturn($type);
