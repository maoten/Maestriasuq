...
class Swift_Mime_MimePartTest extends Swift_Mime_AbstractMimeEntityTest
{
    ...
    public function testCharsetIsReturnedFromHeader()
    {
     ...
     Content-type: text/plain; charset=iso-8859-1
        ...
        */
        ...
        $cType = $this->_createHeader('Content-Type', 'text/plain', [ 'charset' => 'iso-8859-1' ]);
    ...
    {
        $cType = $this->_createHeader('Content-Type', 'text/plain', [ 'charset' => 'iso-8859-1' ], false);
    ...
    public function testSettingCharsetNotifiesEncoder()
    {
        ...
        $encoder->expects($this->once())->method('charsetChanged')->with('utf-8');
    ...
    public function testSettingCharsetNotifiesHeaders()
    {
        ...
        $headers->shouldReceive('charsetChanged')->zeroOrMoreTimes()->with('utf-8');
     ...
     */
        ...
        $cType = $this->_createHeader('Content-Type', 'text/plain', [ 'format' => 'flowed' ]);
        $part  = $this->_createMimePart($this->_createHeaderSet([
            'Content-Type' => $cType,
        ]), $this->_createEncoder(), $this->_createCache());
     ...
     */
        ...
        $cType = $this->_createHeader('Content-Type', 'text/plain', [ 'delsp' => 'no' ]);
        $part  = $this->_createMimePart($this->_createHeaderSet([
            'Content-Type' => $cType,
        ]), $this->_createEncoder(), $this->_createCache());
    ...
    public function testFluidInterface()
    {
        ...
        $this->assertSame($part,
            $part->setContentType('text/plain')->setEncoder($this->_createEncoder())->setId('foo@bar')->setDescription('my description')->setMaxLineLength(998)->setBody('xx')->setBoundary('xyz')->setChildren([ ])->setCharset('utf-8')->setFormat('flowed')->setDelSp(true));
    }
