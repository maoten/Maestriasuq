...
class Swift_StreamFilters_ByteArrayReplacementFilterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testBasicReplacementsAreMade()
    {
        ...
        $this->assertEquals([ 0x59, 0x60, 0x63, 0x64, 0x65 ], $filter->filter([ 0x59, 0x60, 0x61, 0x62, 0x65 ]));
    }
    ...
    public function testFilterCanMakeMultipleReplacements()
    {
        ...
        $this->assertEquals([ 0x60, 0x63, 0x60, 0x63, 0x60 ], $filter->filter([ 0x60, 0x61, 0x60, 0x62, 0x60 ]));
    }
    ...
    {
        $filter = $this->_createFilter([ [ 0x61 ], [ 0x62 ] ], [ [ 0x63 ], [ 0x64 ] ]);
        $this->assertEquals([ 0x60, 0x63, 0x60, 0x64, 0x60 ], $filter->filter([ 0x60, 0x61, 0x60, 0x62, 0x60 ]));
    }
    ...
    {
        $filter = $this->_createFilter([ [ 0x0D, 0x0A ], [ 0x0D ], [ 0x0A ] ], [ [ 0x0A ], [ 0x0A ], [ 0x0D, 0x0A ] ]);

        $this->assertEquals([ 0x60, 0x0D, 0x0A, 0x61, 0x0D, 0x0A, 0x62, 0x0D, 0x0A, 0x63 ],
