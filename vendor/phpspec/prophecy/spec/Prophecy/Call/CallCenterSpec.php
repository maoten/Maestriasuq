...
class CallCenterSpec extends ObjectBehavior
{
    ...
    function it_executes_promise_of_method_prophecy_that_matches_with_highest_score_to_makeCall(
        ...
        $promise->execute([ 'world', 'everything' ], $objectProphecy->getWrappedObject(),
            $method2)->willReturn('second');

        $this->makeCall($objectProphecy, 'getName', [ 'world', 'everything' ])->shouldReturn('second');
    }
    ...
    function it_throws_exception_if_call_does_not_match_any_of_defined_method_prophecies(
        ...
        $this->shouldThrow('Prophecy\Exception\Call\UnexpectedCallException')->duringMakeCall($objectProphecy,
                'getName', [ 'world', 'everything' ]);
    }
    ...
    function it_returns_null_if_method_prophecy_that_matches_makeCall_arguments_has_no_promise(
        ...
        $this->makeCall($objectProphecy, 'getName', [ 'world', 'everything' ])->shouldReturn(null);
    }
