...
class MethodProphecySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldThrow('Prophecy\Exception\Doubler\MethodNotFoundException')->during('__construct',
            [ $objectProphecy, 'getUnexisting', null ]);
    }
    ...
    function its_constructor_throws_MethodProphecyException_for_final_methods($objectProphecy, $subject)
    {
        ...
        $this->shouldThrow('Prophecy\Exception\Prophecy\MethodProphecyException')->during('__construct',
    ...
    function it_records_even_failed_checked_predictions(
        ...
        $objectProphecy->addMethodProphecy($this)->willReturn(null);
        $prediction->check([ $call1, $call2 ], $objectProphecy->getWrappedObject(),
