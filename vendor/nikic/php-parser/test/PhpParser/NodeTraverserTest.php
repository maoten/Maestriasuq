...
class NodeTraverserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testModifying()
    {
        ...
        $visitor1->expects($this->at(0))->method('beforeTraverse')->with([ ])->will($this->returnValue([ $str1Node ]));
        ...
        $visitor1->expects($this->at(5))->method('afterTraverse')->with([ $str1Node ])->will($this->returnValue([ ]));
    ...
    public function testMerge()
    {
        ...
        $this->assertEquals([ $strStart, $strR1, $strR2, $strEnd ],
