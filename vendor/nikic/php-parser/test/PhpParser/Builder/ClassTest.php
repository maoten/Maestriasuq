...
class ClassTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testStatementOrder()
    {
        ...
        $property = new Stmt\Property(Stmt\Class_::MODIFIER_PUBLIC, [ new Stmt\PropertyProperty('testProperty') ]);
...
DOC;
        ...
        $class = $this->createClassBuilder('Test')->setDocComment(new Comment\Doc($docComment))->getNode();
    ...
    {
        $this->createClassBuilder('Test')->extend([ 'Foo' ]);
    }
}
