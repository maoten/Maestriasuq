    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="panel-body">
                        <div>
                            <form class="form-horizontal" role="form" method="GET"
                                  action="{{ route('admin.trabajogrado.asignarJurados', $trabajogrado->id) }}">

                                @if(App\JuradoTrabajogrado::where('trabajogrado_id',$trabajogrado->id)->first()==null)
                                    <p class="text-center">Este trabajo de grado no tiene jurados asignados aún.<br>Antes
                                        de
                                        asignar jurados a este trabajo de grado revisa que hay por lo menos 3 jurados
                                        registrados.</p>
                                ...
                                @else
                                    ...
                                    @if(App\Trabajogrado::find($trabajogrado->id)->estado!='aceptado'and App\Trabajogrado::find($trabajogrado->id)->estado!='aplazado')
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <select class="chosen" multiple="true" style="width:300px;"
                                                        ...
                                                        @foreach(App\User::where('rol','jurado')->get() as $jurado)
                                                            <?php $jurad = App\JuradoTrabajogrado::where('jurado_id',
                                                                    $jurado->id)->where('trabajogrado_id',
                                                                    $trabajogrado->id)->first() ?>
                                                            @if($jurad!=null)
                ...
                <?php $evaluaciones = App\Evaluacion::where('trabajogrado_id', $trabajogrado->id)->get();?>
                @if($evaluaciones->count() == 3 )
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <p class="text-justify">El trabajo de grado {{ $trabajogrado->titulo }} ha sido
                                aceptado.</p>
                            <HR>
