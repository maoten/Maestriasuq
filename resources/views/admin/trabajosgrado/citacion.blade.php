            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default ">
                    <div class="panel-heading"><h4><i class="fa fa-calendar-check-o iconoizq"></i>Citación a disertación
                            del trabajo de grado: {{ $trabajogrado->titulo }}
                        </h4></div>
                    ...
                    <div class="panel-body text-justify">
                        ...
                        @if($disertacion!=null)
                            <p>Este trabajo de grado ya tiene asignada una disertación en la siguiente
                            ...
                            @if(App\Trabajogrado::find($trabajogrado->id)->estado!='aceptado'and App\Trabajogrado::find($trabajogrado->id)->estado!= 'aplazado')
                                <p>Para asignar una nueva fecha y cancelar la actual, haz click en el siguiente botón y
                                    llena el formulario.</p><a
                                        href="{{ route('admin.trabajogrado.cancelarCitacion', $trabajogrado->id) }}"
                        ...
                        @else
                            ...
                            <form class="form-horizontal" role="form" method="GET"
                                  action="{{ route('admin.trabajogrado.citar', $trabajogrado->id) }}">
                                {!! csrf_field() !!}
                                <p class="text-justify">Se citara a la disertación a todos los involucrados con este
                                    trabajo de grado (estudiante, director de grado, jurados).</p>
                                <HR>
