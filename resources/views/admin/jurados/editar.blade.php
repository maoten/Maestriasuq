                     ...
                     <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="nombre" value="{{ $jurado->nombre }}" placeholder="Leonardo Correa" >
                    ...
                    <div class="form-group{{ $errors->has('cc') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="cc" value="{{ $jurado->cc }}" placeholder="1098626573" >
                    ...
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" name="email" value="{{ $jurado->email }}" placeholder="lcorrea@uniquindio.edu.co" >
                    ...
                    <div class="form-group{{ $errors->has('telefono') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="telefono" value="{{ $jurado->telefono }}" placeholder="3007645231" >
                    ...
                    <div class="form-group{{ $errors->has('profesion') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="profesion" value="{{ $jurado->profesion }}" placeholder="Ingeniero de sistemas y computación" >
