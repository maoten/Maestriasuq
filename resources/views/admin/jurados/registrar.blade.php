...
@section('title', 'Registro de jurado')
@section('css')
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading text-center">Registro de jurado</div>
                <div class="panel-body">



                    <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.jurados.store') }}"  enctype="multipart/form-data" >
                       {!! csrf_field() !!}
