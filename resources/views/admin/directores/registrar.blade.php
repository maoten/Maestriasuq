...
@section('title', 'Registro de director de grado')
@section('css')
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading text-center">Registro de director de grado</div>
                <div class="panel-body">



                    <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.directores.store') }}" >
                       {!! csrf_field() !!}
