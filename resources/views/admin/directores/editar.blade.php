                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="PUT"
                              action="{{ route('admin.directores.update', [$director]) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="nombre"
                                               value="{{ $director->nombre }}" placeholder="Leonardo Correa">
                            ...
                            <div class="form-group{{ $errors->has('cc') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="cc" value="{{ $director->cc }}"
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" name="email"
                                               value="{{ $director->email }}" placeholder="lcorrea@uniquindio.edu.co">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="telefono"
                                               value="{{ $director->telefono }}" placeholder="3007645231">
