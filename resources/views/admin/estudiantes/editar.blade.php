            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h4><span class="glyphicon glyphicon-pencil iconoizq"
                                                         aria-hidden="true"></span>Edición de estudiante</h4></div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="nombre"
                                               value="{{ $estudiante->nombre }}" placeholder="Leonardo Correa">
                            ...
                            <div class="form-group{{ $errors->has('cc') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="cc" value="{{ $estudiante->cc }}"
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" name="email"
                                               value="{{ $estudiante->email }}" placeholder="lcorrea@uniquindio.edu.co">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="telefono"
                                               value="{{ $estudiante->telefono }}" placeholder="3007645231">
