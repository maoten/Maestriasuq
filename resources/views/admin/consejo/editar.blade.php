        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="PUT" action="{{ route('admin.consejo.update', [$consejo]) }}">
                     ...
                     <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="nombre" value="{{ $consejo->nombre }}" placeholder="Leonardo Correa" >
                    ...
                    <div class="form-group{{ $errors->has('cc') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="cc" value="{{ $consejo->cc }}" placeholder="1098626573" >
                    ...
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" name="email" value="{{ $consejo->email }}" placeholder="lcorrea@uniquindio.edu.co" >
                    ...
                    <div class="form-group{{ $errors->has('telefono') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="telefono" value="{{ $consejo->telefono }}" placeholder="3007645231" >
                    ...
                    <div class="form-group{{ $errors->has('profesion') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="profesion" value="{{ $consejo->profesion }}" placeholder="Ingeniero de sistemas y computación" >
                    ...
                    <div class="form-group{{ $errors->has('unievrsidad') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="universidad" value="{{ $consejo->universidad }}"placeholder="Universidad del Quindío" >
