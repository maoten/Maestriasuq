...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading text-center">Edicíón de propuesta</div>
            <div class="panel-body">



                <form class="form-horizontal" role="form" method="POST" action="{{ route('estudiante.propuesta.update') }}"  enctype="multipart/form-data" >
                   {!! csrf_field() !!}
                   ...
                   <div class="form-group{{ $errors->has('titulo') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="titulo" value="{{ $propuesta->nombre }}" placeholder="" >
                ...
                <div class="form-group{{ $errors->has('enfoque') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <select class="form-control" name="enfoque" selected="{{ $propuesta->enfoque }}">
            ...
            <div class="form-group{{ $errors->has('dir_id') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <select class="form-control" name="dir_id"  selected="{{ $propuesta->dir_id }}">
