...
@section('title', 'Evaluación trabajo de grado')
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading text-center">Evaluación del trabajo de
                        grado: {{ $trabajogrado->titulo }}</div>
                    <div class="panel-body">


                        @if(App\Evaluacion::where('user_id',Auth::user()->id)->where('trabajogrado_id',$trabajogrado->id)->first()!=null)
                            <p>La evaluación para este trabajo de grado ya fue enviada y no se puede modificar.</p>
                        @else

                            <form class="form-horizontal" role="form" method="POST"
                                  action="{{ route('jurado.trabajogrado.evaluar', [$trabajogrado]) }}"
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-4">
                                        <button type="submit" class="btn btn-primary" name="evaluar"
                                                onclick="return confirm('¿Esta seguro/a de que desea evaluar este trabajo de grado? \n Una vez la evaluación sea enviada no será posible editarla.')">
                                            Enviar evaluación
                                        </button>
                                    </div>
                                </div>
