      ...
      <div class="collapse navbar-collapse" id="app-navbar-collapse">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <!--descomentar y poner lo otro en el else -->
                                    ...
                                    <?php $notificaciones=App\Notificacion::where('user_id', Auth::user()->id)->where('estado','sin leer')->orderBy('created_at')->get(); ?>
                                    ...
                                    <li class="dropdown">
                                      ...
                                      <ul class="dropdown-menu">
                                        ...
                                        <li class="msj">
                                        <p class="text-center"><small class="text-muted"><i class="fa fa-circle-o iconoizq" aria-hidden="true"></i></small>
                                            {{ substr($notificacion->notificacion,  0, 24) }}...</p>
                                          </li>  
                                          ...
                                          <li class="footernotif"><a href="{{route('estudiante.notificaciones.index') }}">Ver todas</a></li>
                                          @elseif(Auth::user()->rol=='director_grado')
                                          <li class="footernotif"><a href="{{route('director.notificaciones.index') }}">Ver todas</a></li>
                                           @elseif(Auth::user()->rol=='consejo_curricular')
                                          <li class="footernotif"><a href="{{route('consejo.notificaciones.index') }}">Ver todas</a></li>
                                           @elseif(Auth::user()->rol=='jurado')
                                          <li class="footernotif"><a href="{{route('jurado.notificaciones.index') }}">Ver todas</a></li>
                                          @endif
