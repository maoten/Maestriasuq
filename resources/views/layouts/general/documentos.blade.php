...
<div class="col-md-4 text-center">
    <a href="{{asset('sistema/documentos/Plantilla Tesis MSEng. Profundización versión 2.0.docx')}}">
        <img src="{{ asset('imagenes/word.png') }}">
        <h5>Plantilla Tesis MSEng.<BR>Profundización version 2.0</h5>
    </a>
</div>
<div class="col-md-4 text-center">
    <a href="{{asset('sistema/documentos/estatutoEstudiantilPostgrado.pdf')}}" target="_blank">
