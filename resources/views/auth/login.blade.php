        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="alert alert-warning alert-dismissible" role="alert">
                    ...
                    <strong>Atención:</strong> Ingresa con tu correo electrónico y la contraseña que te fue dada, una
                    vez adentro podrás cambiarla ingresando a la opción "cuenta".
                </div>
