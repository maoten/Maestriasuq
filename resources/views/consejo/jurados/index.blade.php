              ...
              <tbody>
                ...
                <tr> 
                    ...
                    <td>
                        ...
                        <a href="{{ route('consejo.jurados.edit', $jurado->id) }}" class="btn btn-warning" title="Editar"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                        </a> 
                        <a href="{{ route('consejo.jurados.destroy', $jurado->id) }}" onclick="return confirm('¿Deseas eliminar este jurado?')"  class="btn btn-danger" title="Eliminar"><i class="fa fa-times"></i>
                        </a>
